      ...
      >
        <div className="flex flex-col">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <div className="flex items-center gap-1.5">
                  <span className="text-base font-bold tracking-tight text-slate-900">HydroMesh</span>
                  <span className="px-1.5 py-0.5 rounded bg-cyan-100 text-cyan-800 text-[11px] font-semibold">v2.4</span>
                </div>

                <span className="text-[12px] text-slate-500 font-medium">Weather &amp; Soil Station</span>
              </div>
            </div>

            {/* Close button, mobile only */}
            <button className="lg:hidden text-slate-400 hover:text-slate-700" onClick={() => setIsOpen(false)} aria-label="Close sidebar">
          ...
          <div className="px-4 pt-5 pb-2">
            <span className="text-[11px] uppercase tracking-wider text-slate-400 font-bold">Navigation</span>
          </div>
              ...
              return (
                <Link
                  ...
                  className={`flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-150 ${
                    active ? "bg-cyan-50 text-cyan-800 font-semibold border-l-4 border-cyan-600" : "text-slate-600 hover:bg-slate-100 hover:text-slate-900"
                  }`}
                >
                  <span className={`material-symbols-outlined text-[20px] ${active ? "text-cyan-700" : ""}`}>{item.icon}</span>
